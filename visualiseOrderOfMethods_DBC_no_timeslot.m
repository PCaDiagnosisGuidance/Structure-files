...
% 
NrCombinations1=findOrderMethods(methodsperPSA1, scalar, DBC_code_no_timeframe(:, 1));
NrCombinations2=findOrderMethods(methodsperPSA2, scalar, DBC_code_no_timeframe(:, 2));
NrCombinations3=findOrderMethods(methodsperPSA3, scalar, DBC_code_no_timeframe(:, 3));
